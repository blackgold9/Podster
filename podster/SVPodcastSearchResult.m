...
@synthesize title, summary, feedURL, podstoreId,  websiteURL, logoURL, tinyLogoURL,smallLogoURL,thumbLogoURL, subtitle, unseenEpsiodeCount, lastSynced, lastUpdated;
